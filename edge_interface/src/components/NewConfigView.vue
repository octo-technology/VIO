      ...
      <v-form @submit.prevent="submitConfig">
        ...
        <div v-for="(cameraConfig, cameraId) in NewConfig.camera_configs" :key="cameraId">
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-select v-model="cameraConfig.camera_type" :items="cameraTypes" label="Camera Type" required></v-select>
            </v-col>
            ...
            <v-col cols="12" md="6">
              <v-select v-model="cameraConfig.model_forwarder_config.model_name" :items="modelNames" label="Model Name"
                required></v-select>
            </v-col>
            <v-col cols="12" md="6">
              <v-select v-model="cameraConfig.model_forwarder_config.model_type" :items="modelTypes" label="Model Type"
                required></v-select>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field v-model="cameraConfig.model_forwarder_config.expected_image_resolution.width"
                label="Image Resolution Width" required></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field v-model="cameraConfig.model_forwarder_config.expected_image_resolution.height"
                label="Image Resolution Height" required></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field v-model="cameraConfig.model_forwarder_config.model_version" label="Model Version"
                required></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <div v-for="(className, index) in cameraConfig.model_forwarder_config.class_names" :key="index">
                <v-text-field v-model="cameraConfig.model_forwarder_config.class_names[index]" label="Class Name"
                  required></v-text-field>
            ...
            <v-col cols="12" md="6">
              ...
              <div v-if="cameraConfig.showClassNamesFilepath">
                <v-text-field v-model="cameraConfig.model_forwarder_config.class_names_filepath"
                  label="Class Names Filepath"></v-text-field>
              </div>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field v-model="cameraConfig.model_forwarder_config.model_serving_url" label="Model Serving URL"
                required></v-text-field>
            </v-col>
            <v-col cols="12">
            ...
            <v-col cols="12" md="6">
              <v-select v-model="cameraConfig.camera_rule_config.camera_rule_type" :items="cameraRuleTypes"
                label="Camera Rule Type" required></v-select>
            </v-col>
            <v-col cols="12" md="6" v-if="cameraConfig.camera_rule_config.camera_rule_type === 'expected_label_rule'">
              <v-text-field v-model="cameraConfig.camera_rule_config.expected_class"
                label="Expected Class"></v-text-field>
            </v-col>
            <v-col cols="12" md="6" v-if="cameraConfig.camera_rule_config.camera_rule_type === 'unexpected_label_rule'">
              <v-text-field v-model="cameraConfig.camera_rule_config.unexpected_class"
                label="Unexpected Class"></v-text-field>
            </v-col>
            <v-col cols="12" md="6"
              v-if="cameraConfig.camera_rule_config.camera_rule_type === 'min_nb_objects_rule' || cameraConfig.camera_rule_config.camera_rule_type === 'max_nb_objects_rule'">
              <v-text-field v-model="cameraConfig.camera_rule_config.class_to_detect"
                label="Class to Detect"></v-text-field>
            </v-col>
            <v-col cols="12" md="6"
              v-if="cameraConfig.camera_rule_config.camera_rule_type === 'min_nb_objects_rule' || cameraConfig.camera_rule_config.camera_rule_type === 'max_nb_objects_rule'">
              <v-text-field v-model="cameraConfig.camera_rule_config.threshold" label="Threshold"
                required></v-text-field>
            </v-col>
            <v-col cols="12">
        ...
        <v-select v-model="NewConfig.binary_storage_config.storage_type" :items="storageTypes" label="Storage Type"
          required></v-select>
        <v-text-field v-model="NewConfig.binary_storage_config.target_directory" label="Target Directory"
          required></v-text-field>
        ...
        <v-select v-model="NewConfig.metadata_storage_config.storage_type" :items="storageTypes" label="Storage Type"
          required></v-select>
        <v-text-field v-model="NewConfig.metadata_storage_config.target_directory" label="Target Directory"
          required></v-text-field>
        ...
        <v-select v-model="NewConfig.item_rule_config.item_rule_type" :items="itemRuleTypes" label="Item Rule Type"
          required></v-select>
        <v-text-field v-model="NewConfig.item_rule_config.expected_decision" label="Expected Decision"
          required></v-text-field>
