...
class ModelInfos:
    ...
    @classmethod
    def from_model_graph_node(cls, camera_id: str, model_id: str, model: Dict, inventory: Inventory, data_folder: Path):
        ...
        try:
            boxes_coordinates = inventory.models[model_type].get('output').get('boxes_coordinates')
    ...
    def __eq__(self, other) -> bool:
        return (other.name == self.name and
                ...
                other.depends_on == self.depends_on and
                other.camera_id == self.camera_id and
                other.class_names == self.class_names and
                other.class_names_path == self.class_names_path and
                other.boxes_coordinates == self.boxes_coordinates and
                other.objectness_scores == self.objectness_scores and
                other.number_of_boxes == self.number_of_boxes and
                other.detection_classes == self.detection_classes and
                other.image_resolution == self.image_resolution and
                other.class_to_detect == self.class_to_detect and
                other.objectness_threshold == self.objectness_threshold
                )
