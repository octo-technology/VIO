...
class CameraRuleFactory(ICameraRuleFactory):
    ...
    def create_camera_rule(self, camera_rule_config: CameraRuleConfig) -> ICameraRule:
        ...
        if camera_rule_type == CameraRuleType.EXPECTED_LABEL_RULE.value:
        ...
        elif camera_rule_type == CameraRuleType.MAX_NB_OBJECTS_RULE.value:
        ...
        elif camera_rule_type == CameraRuleType.MIN_NB_OBJECTS_RULE.value:
