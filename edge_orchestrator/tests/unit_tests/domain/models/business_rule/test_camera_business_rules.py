...
class TestCameraBusinessRule:
    ...
    def test_camera_decision_should_return_OK_when_minimum_one_person_is_detected(self):
        # Given
        inferences = {
            "camera_id3": {
                "model_id5": {
    ...
    def test_camera_decision_should_return_OK_when_minimum_one_face_is_detected_with_two_object_detection_models(  # noqa
        self,
    ):
        # Given
        inferences = {
