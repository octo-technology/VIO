from edge_orchestrator.infrastructure.model_forward.tf_serving_detection_wrapper import TFServingDetectionWrapper
...
class TestDetectionWrapperHelper:
    ...
    def test_perform_post_processing_should_transform_the_standard_output_from_the_model_into_the_expected_format(self):
        ...
        model = ModelInfos('id1', 'name1', 'detection', '1', 'camera_id1', image_resolution=[640, 640],
                           class_names=['OK', 'KO'], boxes_coordinates='detection_boxes',
                           objectness_scores='detection_scores', number_of_boxes='num_detections',
                           detection_classes='detection_classes', class_to_detect=['foo'],
