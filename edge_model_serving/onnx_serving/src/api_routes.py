...
async def get_models(request: Request):
    return list(request.app.state.model_interpreters.keys())  # Retourne les modèles disponibles
...
async def predict_test_image(model_name: str, model_version: str, request: Request):
    ...
    session = request.app.state.model_interpreters[model_name] # recuperer la session d'inference du modèle 
