...
from supervisor.api_config import get_station_config
...
class TestEdgeStation:
    ...
    def test_register_cameras_raises_exception_when_no_active_configuration_is_set(self):
        # Given
    ...
    @patch('supervisor.domain.models.item.generate_id')
    def test_capture_should_instantiate_item_with_1_binary(self,
                                                           generate_id_mocked,
                                                           capture_mocked,
                                                           my_fake_item_2,
                                                           my_fake_binaries_2):
