...
class TestItemBusinessRule:
    def test_item_decision_should_return_decision_ko_when_one_or_more_than_one_camera_decision_is_ko(self): # noqa
        # Given
    ...
    def test_item_decision_should_return_decision_ok_when_more_than_50_pct_of_camera_decisions_are_ok(self):  # noqa
        # Given
