...
def main():
    ...
    for edge_name in st.session_state.edge_names:
        if edge_name not in st.session_state.edge_data_manager.get_edge_names():
            ...
            st.session_state.edge_data_manager.add_edge(edge_data)

        edge_data = st.session_state.edge_data_manager.get_edge(edge_name)
